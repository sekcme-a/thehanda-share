...
const Letsgo = () => {
  ...
  return(
    <Wrapper>
      <div style={{width:"100vw", height:"100vh", backgroundColor:"white", display:"flex", justifyContent:"center", alignItems:"center", cursor:"pointer"}} onClick={()=>router.push("/dragndrop")}>
        <h1 style={{fontSize: "50px", whiteSpace:"pre-line", textAlign:'center', lineHeight:1.5, fontWeight:"bold"}}>
        <TypewriterComponent
          onInit={(typewriter) => {
            typewriter
            .pauseFor(300)
            .typeString('그렇게 도착한 한국,')
            .pauseFor(500)
            .typeString('<br/>취업을 위한 이력서를 써볼까요?')
            .start()
